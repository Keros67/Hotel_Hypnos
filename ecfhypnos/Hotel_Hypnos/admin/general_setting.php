...
<div id="content" class="p-4 p-md-5 pt-5">
  ...
  <div class="container-fluid col-11" id="contentArea">
    <h4 class="mb-4 mt-5 ">Détails sur l'hotel</h4>
    ...
    <form id="gs_form" method="POST" action="admin_functions.php" enctype="multipart/form-data" autocomplete="off">
      ...
      <div class="row">
        ...
        <div class="input-group col-lg-6 mb-4">
          <div class="ml-2">
            <label for="companyName">Nom de l'hotel</label>
          </div>
          <div class="input-group ">
            ...
            <input id="companyName" type="text" name="companyName" class="form-control bg-white border-left-0 border-md"
              required>
          </div>
        </div>
        ...
        <div class="input-group col-lg-6 mb-4">
          <div class="ml-2">
            <label for="address1">Addresse Ligne 1</label>
          </div>
          <div class="input-group ">
            <div class="input-group-prepend">
              <span class="input-group-text bg-white px-4 border-md border-right-0">
            ...
            <input id="address1" type="text" name="address1" class="form-control bg-white border-left-0 border-md"
              required>
          </div>
        </div>
        ...
        <div class="input-group col-lg-4 mb-4">
          <div class="ml-2">
            <label for="address2">Addresse Ligne 2</label>
          </div>
          <div class="input-group ">
            <div class="input-group-prepend">
              <span class="input-group-text bg-white px-4 border-md border-right-0">
            ...
            <input id="address2" type="text" name="address2" class="form-control bg-white border-left-0 border-md"
              required>
          </div>
        </div>
        <!-- Address -->
        ...
        <div class="input-group col-lg-3 mb-4">
          ...
          <div class="input-group ">
            ...
            <input id="country" type="text" name="country" class="form-control bg-white border-left-0 border-md"
              required>
          </div>
        </div>
        <!-- Address -->
        ...
        <div class="input-group col-lg-6 mb-4">
          ...
          <div class="input-group ">
            ...
            <input id="description" type="text" name="description" class="form-control bg-white border-left-0 border-md"
              required>
          </div>
        </div>
        ...
        <h4 class="mb-4 mt-5 ml-4">Contact Détails</h4>
        ...
        <div class="input-group col-lg-6 mb-4">
          <div class="ml-2">
            <label for="teleNumber">Portable</label>
          </div>
          <div class="input-group ">
            <div class="input-group-prepend">
              <span class="input-group-text bg-white px-4 border-md border-right-0">
            ...
            <input id="teleNumber" type="tel" name="teleNumber"
              class="form-control bg-white border-md border-left-0 pl-3" required>
          </div>
        </div>
