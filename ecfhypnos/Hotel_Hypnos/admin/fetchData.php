...
<thead class="thead-dark">
  ...
  <tbody>';
   ...
   if($userFilter==""){
    $selectAllUser = "SELECT * FROM users_details where FirstName <> 'Sylvain' ";
   }else{
    $selectAllUser = "SELECT * FROM users_details WHERE Status like '".$userFilter."' AND FirstName <> 'Sylvain' ";
   }
    ...
    if($noOfUsers>=1){
        while($row=mysqli_fetch_assoc($allUser))
        {
          ...
          $userTable.=' <tr>
              ...
              $userTable.="<button class='btn btn-secondary'  name='EditUser' onclick=\" editUser('".$row["UserId"]."') \">Modifier</button>";
              $userTable.="<button class='btn btn-danger' name='deleteUser' onclick=\"confirm('Voulez-vous effacer  ".$row["FirstName"]."') && deleteUser('".$row["UserId"]."')\">Effacer</button>
    ...
    else 
    {
      ...
      $userTable.='<tr><td colspan="8" style="color:red;text-align:center;">Aucun enregistrement trouvé </td></tr>';
...
$returnData.='<div class="col-12 alert alert-danger">' . $_POST["error"] . '</div>';
  ...
  foreach($images as $image) {
    $returnData.=' <div class="col-sm-6 col-md-4 col-lg-3 item">
              ...
              <div class="overlay">';
              $returnData.="    <a class='info' href='#'  onclick=\"confirm('Voulez-vous effacer cette image ?') && deleteImage('".$image."')\">Effacer</a>
              </div>
              </div>
          </div>";
...
<thead class="thead-dark">
  ...
  <tbody>';
   ...
   switch($roomTypeFilter){
      ...
      case 4:  $selectAllType = "SELECT * FROM room_type WHERE Cost < 150 ";break;
      case 5:  $selectAllType = "SELECT * FROM room_type WHERE Cost >=150 AND Cost<=200 ";break;
      case 6:  $selectAllType = "SELECT * FROM room_type WHERE Cost >200 ";break;
    ...
    if($noOfType>=1){
        while($row=mysqli_fetch_assoc($allType))
        {
          ...
          $typeTable.=' <tr>
              ...
              $typeTable.="<button class='btn btn-secondary'  name='EditUser' onclick=\" editRoomType('".$row["RoomTypeId"]."') \"> Modifier </button>";
              $typeTable.="<button class='btn btn-danger' name='deleteUser' onclick=\"confirm('Voulez-vous effacer  ".$row["RoomType"]."') && deleteRoomType('".$row["RoomTypeId"]."')\">Effacer</button>
    ...
    else 
    {
      ...
      $typeTable.='<tr><td colspan="8" style="color:red;text-align:center;">Enregistrement introuvable </td></tr>';
  ...
  <tbody>';
   ...
   if($roomFilter==""){
    ...
    if($noOfrooms>=1){
        while($row=mysqli_fetch_assoc($allRoom))
        {
          ...
          $roomTable.=' <tr>
              ...
              $roomTable.="<button class='btn btn-secondary'  name='EditUser' onclick=\" editRoom('".$row["RoomId"]."') \">Modifier</button>";
              $roomTable.="<button class='btn btn-danger' name='deleteUser' onclick=\"confirm('Voulez-vous supprimer le numéro de chambre  ".$row["RoomNumber"]."') && deleteRoom('".$row["RoomId"]."')\">Effacer</button>
    ...
    else 
    {
      ...
      $roomTable.='<tr><td colspan="8" style="color:red;text-align:center;">Enregistrement introuvable </td></tr>';
       ...
       while($row=mysqli_fetch_assoc($booking))
       {
         ...
         $roomTable.=' <tr>
               ...
               ';
                          ...
                          <a href="#" class="btn btn-danger btn-sm" onclick="confirm(\'Are you sure ? Do you want to Cancel this Booking \') && setReject(\''.$row["BookingId"].'\')">Annuler</a>
                              ...
                              <button class="btn btn-secondary btn-sm" onclick="confirm(\'Etes-vous sur ? Voulez-vous rendre cette chambre libre \') && setFree(\''.$row["BookingId"].'\')">Libérer</button>
                              ...
                              <span>Annulée par le client</span>
                              </td>	';
                          } 
                          else if ($row['Status']=="Rejected"){
                              $roomTable .='         <td>
                              
                              <span>Annulé par l\'administrateur</span>
                              </td>	';
                          }
                          else{
                              $roomTable .='<td><form action="../include/pdf.php" method="POST" >
                   ...
                   $roomTable.='  <td><button class="btn btn-light btn-sm"  name="showDetails" onclick=" showDetails(\''.$row["BookingId"].'\') "> Voir </button></td> </tr>';
       }
     }
   else 
   {
   
     $roomTable.='<tr><td colspan="12" style="color:red;text-align:center;">Aucun enregistrement trouvé </td></tr>';
...
<thead class="thead-dark">
  ...
  switch($filter){
    ...
    case 7:  $selectPayments =  "SELECT rp.*,rm.*,rt.RoomType,rl.RoomNumber,us.FirstName FROM room_payment rp
                                  ...
                                  inner join room_type rt on rl.RoomTypeId = rt.RoomTypeId 
                                  inner join users_details us on us.Userid = rm.User_id 
                                  where rp.Amount  >= 500 AND rp.Amount <=1000
                                  order by rp.PaymentDate desc";
                                  break;
    ...
    case 8:  $selectPayments =  "SELECT rp.*,rm.*,rt.RoomType,rl.RoomNumber,us.FirstName FROM room_payment rp
                                  ...
                                  inner join room_type rt on rl.RoomTypeId = rt.RoomTypeId 
                                  inner join users_details us on us.Userid = rm.User_id 
                                  where rp.Amount  >= 1000 AND rp.Amount <=1500
                                  order by rp.PaymentDate desc";
                                  break;
   ...
   else 
   {
     ...
     $paymentTable.='<tr><td colspan="12" style="color:red;text-align:center;">Aucun enregistrement trouvé </td></tr>';
...
<thead class="thead-dark">
  ...
  <tbody>';
   ...
   switch($roomTypeFilter){
      ...
      case 4:  $selectAllType = "SELECT * FROM event_type WHERE Cost < 100 ";break;
      case 5:  $selectAllType = "SELECT * FROM event_type WHERE Cost >=150 AND Cost<=200 ";break;
      case 6:  $selectAllType = "SELECT * FROM event_type WHERE Cost >200 ";break;
    ...
    if($noOfType>=1){
        while($row=mysqli_fetch_assoc($allType))
        {
          ...
          $typeTable.=' <tr>
              ...
              $typeTable.="<button class='btn btn-secondary'  name='EditUser' onclick=\" editEventType('".$row["EventTypeId"]."') \"> Modifier</button>";
              $typeTable.="<button class='btn btn-danger' name='deleteUser' onclick=\"confirm('Voulez-vous effacer  ".$row["EventTypeId"]."') && deleteEventType('".$row["EventTypeId"]."')\">Effacer</button>
    ...
    else 
    {
      ...
      $typeTable.='<tr><td colspan="8" style="color:red;text-align:center;">Aucun enregistrement trouvé </td></tr>';
  ...
  <tbody>';
   ...
   if($eventFilter==""){
    ...
    if($noOfEvents>=1){
        while($row=mysqli_fetch_assoc($allEvents))
        {
          ...
          $eventTable.=' <tr>
                    ...
                    <td>
             ';
              $eventTable.="<button class='btn btn-secondary'  name='EditUser' onclick=\" editEvent('".$row["EventId"]."') \">Modifier</button>";
              $eventTable.="<button class='btn btn-danger' name='deleteUser' onclick=\"confirm('Voulez-vous effacer la chambre N°  ".$row["EventId"]."') && deleteEvent('".$row["EventId"]."')\">Effacer</button>
    ...
    else 
    {
      ...
      $eventTable.='<tr><td colspan="8" style="color:red;text-align:center;">Aucun enregistrement trouvé </td></tr>';
       ...
       while($row=mysqli_fetch_assoc($booking))
       {
         ...
         $eventTable.=' <tr>
               ...
               ';
                          ...
                          $eventTable .=' <td>
                          <a href="#" class="btn btn-primary btn-sm" onclick="setPaid(\''.$row["BookingId"].'\')">Payer</a>
                          <a href="#" class="btn btn-danger btn-sm" onclick="confirm(\'Etes-vous sur ? Voulez-vous annuler cette réservation \') && setReject(\''.$row["BookingId"].'\')">Annuler</a>
                              ...
                              <button class="btn btn-secondary btn-sm" onclick="confirm(\'Etes-vous sur ? Voulez-vous rendre disponible cet hotel \') && setFree(\''.$row["BookingId"].'\')">Libérer</button>
                              ...
                              <span>annuler par l\'administrateur</span>
                              </td>	';
                          }
                          else{
                              $eventTable .='<td><form action="../include/pdf.php" method="POST" >
                   ...
                   $eventTable.='  <td><button class="btn btn-light btn-sm"  name="showDetails" onclick=" showDetails(\''.$row["BookingId"].'\') "> Voir </button></td> </tr>';
       }
     }
   else 
   {
   
     $eventTable.='<tr><td colspan="12" style="color:red;text-align:center;">Aucun enregistrement trouvé </td></tr>';
...
switch($filter){
 ...
 case 7:  $selectPayments =  "SELECT ep.*,em.*,et.EventType,el.HallNumber,us.FirstName FROM event_payment ep
                              ...
                              inner join event_type et on el.EventTypeId = et.EventTypeId 
                              inner join users_details us on us.Userid = em.User_id 
                              where ep.Amount >= 500 AND ep.Amount <=1000
                              order by ep.PaymentDate desc";
                              break;
 ...
 case 8:  $selectPayments =  "SELECT ep.*,em.*,et.EventType,el.HallNumber,us.FirstName FROM event_payment ep
                              ...
                              inner join event_type et on el.EventTypeId = et.EventTypeId 
                              inner join users_details us on us.Userid = em.User_id 
                              where ep.Amount >= 1000 AND ep.Amount <=1500
                              order by ep.PaymentDate desc";
                              break;
...
<thead class="thead-dark">
  ...
  <tbody>';
    ...
    if($noOfUsers>=1){
        while($row=mysqli_fetch_assoc($all))
        {
          ...
          $userTable.=' <tr>
              ...
              $userTable.="<button class='btn btn-danger' name='deleteUser' onclick=\"confirm('Voulez-vous effacer ".$row["FirstName"]." Feedback') && deleteContact('".$row["ID"]."')\">Effacer</button>
    ...
    else 
    {
      ...
      $userTable.='<tr><td colspan="5" style="color:red;text-align:center;">Aucun enregistrement trouvé </td></tr>';
