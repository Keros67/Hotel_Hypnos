...
<div id="content" class="p-4 p-md-5 pt-5">
  ...
  <div class="modal fade" id="modelGallery" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="model-addImage" method="POST" action="admin_functions.php" enctype="multipart/form-data"
            autocomplete="off">
  ...
  <div class="container">
    <div class="intro">
      <h2 class="text-center">Hotel Hypnos Galleries</h2>
      <p class="text-center">Toutes les images de la galerie, survolez et supprimez les images</p>
    </div>
