    ...
    <div class="row">
      <div class="col-md-8 mx-auto">
        ...
        <div class="contact-form">
          ...
          <p class="hint-text">Vous avez quelque chose à dire... faites le nous savoir.</p>
          <form id="contact-form" action="functions.php" method="post">
            <div class="row">
              <div class="col-sm-6">
            ...
            <button type="submit" class="btn btn-primary" name="contact-form">Envoyer</button>
          </form>
        </div>
      </div>
    </div>
