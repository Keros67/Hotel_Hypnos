...
if(isset($_SESSION['loggedUserId'])) {
  ...
  <nav id="navbar_top" class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <a class="navbar-brand " href="#"> <i class="fas fa-gem me-4"></i>Hotel Hypnos</a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" dataHypnos-target="#navbarResponsive"
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="room.php">Réserver</a>
              <a class="dropdown-item" href="event.php">Hotels</a>
              <a class="dropdown-item" href="mybooking.php">Mes Réservations</a>
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="dropdown-item" href="room.php">Réserver</a>
              <a class="dropdown-item" href="account.php">Modifier le Profile</a>
              <a class="dropdown-item" href="../destroy.php">Déconnexion</a>
            </div>
          </li>
        </ul>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../events.php">Hotels</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../contact.php">Contact</a>
          </li>
